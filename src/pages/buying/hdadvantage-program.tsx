import { faCheckCircle, faDownload, faExclamationCircle } from '@fortawesome/free-solid-svg-icons'
...
const HDAdvantageProgramPage = (): React.ReactElement => {
  return (
    <Layout>
      ...
      <div className="component row-splitter pt-3 container-gray-background">
        <div className=" pt-0 container-gray-background container">
          <Row>
            <Row className="component column-splitter">
                  ...
                  <div className="component-content sitecore-form">
                    <Form>
                      <Form.Group controlId="formGroupEmail">
                        ...
                        <Button
                          as="a"
                          className={`${styles.submitButton} hd-btn btn-block icon-left icon-download d-flex justify-content-center align-items-center`}
                          title="SEND REQUEST">
              ...
              <Col xs={12} sm={12} md={4} lg={4} className="indent-top p-0">
                <Col
                  xs={12}
                  md={{ span: 10, offset: 1 }}
                  className="component rich-text position-center mw-100 w-auto">
                  <div className="component-content">
                    <hr />
                ...
                <Col
                  xs={{ span: 12, offset: 0 }}
                  md={{ span: 10, offset: 1 }}
                  className="component rich-text indent-bottom indent-top mw-100 w-auto">
                  <div className="component-content">
                    <Row
                      className={`${styles.solutionCompareSnippet} my-5 mx-1 w-100 mw-100 text-center`}>
                      <Col className={`mx-0 p-0 border ${styles.featured}`}>
                        <h3
                          className={`${styles.planTitle} d-inline-block position-relative mx-auto py-2 px-3 container-dark-background text-primary`}>
                          HD
                        ...
                        <ul className={`${styles.planFeatures} m-0 p-0 border-top text-white`}>
                          <li>
                            <FontAwesomeIcon
                              icon={faCheckCircle}
                              color="#25c594"
                ...
                <Row>
                  <Col xs={12} md={6} lg={6}>
                    <div className="card mb-4">
                      ...
                      <img
                        src="/images/visionlink-unified-suite.jpg"
                        alt=""
            ...
            <Col
              ...
              <div className="component-content">
                ...
                <Button
                  as="a"
                  variant="light"
                  className="hd-btn btn-block icon-left icon-download d-flex justify-content-center align-items-center"
                  ...
                  <FontAwesomeIcon
                    icon={faDownload}
                    width={28}
                    className={`${styles.iconLeft} mr-3`}
                  />
